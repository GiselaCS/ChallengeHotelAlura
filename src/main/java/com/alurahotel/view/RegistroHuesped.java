...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(Long idReserva) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHuesped.class.getResource("/com/alurahotel/imagenes/lOGO-50PX.png")));
		...
		txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/alurahotel/imagenes/icon-reservas.png")));
		...
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/alurahotel/imagenes/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/alurahotel/imagenes/Ha-100px.png")));
