...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Busqueda.class.getResource("/com/alurahotel/imagenes/lupa2.png")));
		...
		panel.addTab("Reservas", new ImageIcon(Busqueda.class.getResource("/com/alurahotel/imagenes/reservado.png")), scroll_table, null);
		...
		panel.addTab("Huéspedes", new ImageIcon(Busqueda.class.getResource("/com/alurahotel/imagenes/pessoas.png")), scroll_tableHuespedes, null);
		scroll_tableHuespedes.setVisible(true);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(Busqueda.class.getResource("/com/alurahotel/imagenes/Ha-100px.png")));
