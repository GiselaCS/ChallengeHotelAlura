...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/com/alurahotel/imagenes/aH-40px.png")));
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/com/alurahotel/imagenes/Ha-100px.png")));
		
		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/com/alurahotel/imagenes/reservas-img-3.png")));
		...
		txtFechaEntrada.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/com/alurahotel/imagenes/icon-reservas.png")));
		...
		txtFechaSalida.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/com/alurahotel/imagenes/icon-reservas.png")));
	...
	//aca calculamos el valor de la reserva en base a los dias reservados
