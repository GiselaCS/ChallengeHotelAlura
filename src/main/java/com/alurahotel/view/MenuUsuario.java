...
public class MenuUsuario extends JFrame {
	 ...
	 */
	public MenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/com/alurahotel/imagenes/aH-40px.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alurahotel/imagenes/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alurahotel/imagenes/reservado.png")));
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alurahotel/imagenes/pessoas.png")));
	    ...
	    lblNewLabel_3_1.setBounds(312, 482, 411, 27);
