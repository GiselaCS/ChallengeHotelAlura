...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuPrincipal.class.getResource("/com/alurahotel/imagenes/aH-40px.png")));
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/com/alurahotel/imagenes/menu-img.png")));
		panel.add(imagenFondo);
		
		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);		
		logo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/com/alurahotel/imagenes/aH-150px.png")));
		panel.add(logo);
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Gisela Criollo © 2023");
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseExited(MouseEvent e) {
				imagenLogin.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/com/alurahotel/imagenes/login.png")));				
			}
		});
